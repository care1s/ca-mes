  ...
  <div class="app-container">
    ...
    <div class="page-header md">
      <div class="title-section">
        ...
        <span class="title">产品BOM</span>
        <span class="subtitle">BOM Management</span>
      </div>
...
export default {
  ...
  methods: {
    handleExport() {
      ...
      XLSX.utils.book_append_sheet(wb, ws, '产品BOM')
      
      const now = new Date()
      const filename = `产品BOM_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}.xlsx`
