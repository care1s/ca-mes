  ...
  <div class="app-container">
    ...
    <div class="page-header pro">
      <div class="title-section">
        ...
        <span class="subtitle">Andon Management</span>
      </div>
...
export default {
  ...
  methods: {
    handleExport() {
      ...
      XLSX.utils.book_append_sheet(wb, ws, '异常管理')
      
      const now = new Date()
      const filename = `异常管理_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}.xlsx`
