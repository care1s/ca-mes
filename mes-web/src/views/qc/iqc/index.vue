  ...
  <div class="app-container">
    ...
    <div class="page-header">
      <div class="title-section">
        ...
        <span class="title">来料检验</span>
        <span class="subtitle">IQC Management</span>
      </div>
...
export default {
  ...
  methods: {
    handleExport() {
      ...
      XLSX.utils.book_append_sheet(wb, ws, '来料检验')
      
      const now = new Date()
      const filename = `来料检验_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}.xlsx`
