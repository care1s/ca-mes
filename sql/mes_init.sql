...
CREATE TABLE wm_item_recpt (
    recpt_id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '入库单ID',
    recpt_code VARCHAR(50) NOT NULL COMMENT '入库单号',
    ...
    status VARCHAR(20) DEFAULT 'PENDING' COMMENT '入库状态: PENDING-待入库, PARTIAL-部分入库, COMPLETED-已完成, CANCELLED-已取消',
    inspect_status VARCHAR(20) DEFAULT 'PENDING' COMMENT '检验状态: PENDING-待检, INSPECTING-检验中, PASSED-合格, FAILED-不合格',
    operator_id BIGINT COMMENT '入库人ID',
    operator_name VARCHAR(100) COMMENT '入库人名称',
    ...
    update_by VARCHAR(64) COMMENT '更新者',
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    UNIQUE KEY uk_recpt_code (recpt_code),
...
CREATE TABLE wm_item_recpt_line (
    ...
    quantity_recpted DECIMAL(18,4) DEFAULT 0 COMMENT '已入库数量',
    unit_id BIGINT COMMENT '计量单位ID',
    unit_name VARCHAR(100) COMMENT '计量单位名称',
    ...
    area_id BIGINT COMMENT '库位ID',
    area_name VARCHAR(100) COMMENT '库位名称',
    status VARCHAR(20) DEFAULT 'PENDING' COMMENT '状态: PENDING-待入库, COMPLETED-已完成',
    remark VARCHAR(500) COMMENT '备注',
    create_by VARCHAR(64) COMMENT '创建者',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    update_by VARCHAR(64) COMMENT '更新者',
